            ...
            <ScrollView>
                <View style={{ flex: 1, marginTop: 20, gap: 16 }} className="w-full flex-col items-center">
                    <View style={{ alignSelf: "flex-start" }} className="flex-col gap-1">
                        ...
                        <Text style={{ alignSelf: "flex-end" }} className="font-semibold text-[#D9D9D9] text-[12px]">14.56.03</Text>
                    </View>
                    <View style={{ alignSelf: "flex-end" }} className="flex-col gap-1">
                        ...
                        <Text style={{ alignSelf: "flex-start" }} className="font-semibold text-[#D9D9D9] text-[12px]">15.56.05</Text>
                    </View>
                    <View style={{ alignSelf: "flex-end" }} className="flex-col gap-1">
